...
private const val PRIVACY_POLICY_URL = "https://YOUR_FIREBASE_PROJECT_ID.web.app"
    ...
    Column(
        ...
        Card(
            ...
            Column(
                ...
                Text("Read the full policy online", fontWeight = FontWeight.Bold)
                Text(
                    "The latest policy covers account data, gameplay progress, and gift card reward requests.",
